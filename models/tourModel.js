    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (value) {
          // this only points to the current doc on NEW document creation and not on update.
          return value < this.price;
        },
        message: 'Discount price ({VALUE}) should be below the regualr price',
      },
    },
    summary: {
      type: String,
