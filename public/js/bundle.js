        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              ...
              data: {
                email: email,
                /// Here we can simply ommit the last email
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    var _location$coordinates = _slicedToArray(location.coordinates, 2),
      lat = _location$coordinates[0],
      lng = _location$coordinates[1];
    var lnglat = L.latLng(lng, lat);
    var popup = L.popup(lnglat, {
      content: "<p class=\"location_description\">Day ".concat(location.day, ": ").concat(location.description, "</p>")
    });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _stripeJs.loadStripe)('pk_test_51MMSqwBnzaWGF1I8ZUzQ4fIIeHLkwh6ZPgHGHvIRDKsbkXxKluLUygZ5l6QxYrYvy4aL35w1YLHdBWiigmVrUt9U00QxCAcaY0');
          case 3:
...
if (bookbtn) bookbtn.addEventListener('click', function (e) {
  ...
  var tourId = e.target.dataset.tourId; /// saving data from data attribute from html
  (0, _stripe.bookTour)(tourId); /// calling bookTour from stripe.js and passing in tourId data
});
